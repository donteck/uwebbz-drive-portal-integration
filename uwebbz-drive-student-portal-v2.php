<?php
/**
 * Plugin Name: UWEBBZ Drive Student Portal v2
 * Description: Extends the UWEBBZ student portal with assigned courses and teacher-controlled lesson availability.
 * Version: 2.0.0
