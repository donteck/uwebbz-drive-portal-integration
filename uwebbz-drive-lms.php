 ...
 * Description: Unified Google Drive LMS for WordPress with teacher dashboard, restricted Drive workspace, visual assignments, AI lesson generation, course builder, quizzes, assignments, gradebook, progress, certificates, announcements, cohorts, calendar, reports and notifications.
 * Version: 4.2.0
...
if (!defined('ULD_LMS_VERSION')) define('ULD_LMS_VERSION', '4.2.0');
