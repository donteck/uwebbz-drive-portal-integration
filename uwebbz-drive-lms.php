 ...
 * Description: Unified Google Drive teaching workspace for WordPress: Drive browser, courses, lessons, student assignments, scheduled releases, student portal, and WordPress-to-Drive lesson sync.
 * Version: 3.0.0
...
function uld_lms_teacher_home(){
    ...
    $upcoming=get_posts(['post_type'=>'uld_lesson','post_status'=>'publish','numberposts'=>6,'meta_key'=>'uld_availability','meta_value'=>'scheduled','orderby'=>'meta_value','order'=>'ASC']);
